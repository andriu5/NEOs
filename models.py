...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self.time = info.get(cd_to_datetime('cd'), None)  # TODO: Use the cd_to_datetime function for this attribute.
        self.distance = info.get(float('dist'), 0.0)
        self.velocity = info.get(float('v_rel'), 0.0)
    ...
    def time_str(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname for this object.
        self.neo = NearEarthObject(self._designation, )
