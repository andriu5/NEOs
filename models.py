...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if not math.isnan(self.diameter):
            ...
            return f"NEO {self.fullname} has an unknown diameter because the data doesn't include this information, " \
                f"and it {'is' if self.hazardous else 'is not'} potentially hazardous."
